        ...
        <div className="pb-8   p-2  flex flex-col gap-10 pt-0 mx-auto md:pt-8">
          ...
          <p className="pr-6 text-justify">I'd love to connect and collaborate with you. Whether you have a project in mind, a question, or just want to say hello, feel free to reach out.</p>
            <div className="flex gap-2 items-center">
              <a href="mailto:michaelhaile12@yahoo.com" ><IoIosMail size={35}/></a>
              <a href="mailto:michaelhaile12@yahoo.com">michaelhaile12@yahoo.com</a>
            </div>            
          <div className="flex gap-6">
            <a href="https://www.linkedin.com/in/hailemichael-assefa-413614223/"><FaLinkedin size={35} /></a>
            <a href="https://github.com/haile12michael12"><FaGithub size={35} /></a>
            <a href="https://www.instagram.com/haile12michael/"><GrInstagram  size={35}/></a>
          </div>
        </div>
